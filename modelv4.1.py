...
# =============================================================================
# ONE-HOT ЭНКОДЕР (ЗАМЕНА LABEL ENCODING)
# =============================================================================
class OneHotFeatureEncoder:
    """
    One-Hot Encoder для категориальных признаков.
    Гарантирует 100% согласованность колонок между обучением и инференсом.
    """
...
# =============================================================================
# 1. ГЕНЕРАТОР С ПЛАВАЮЩИМ ПРОЦЕНТОМ ФРОДА (0.5-2%)
# =============================================================================
...
# =============================================================================
# 2. CAUSAL FEATURE ENGINEER (O(N) + ЗАЩИТА ОТ LEAKAGE)
# =============================================================================
...
# =============================================================================
# 3. ГИБРИДНЫЙ ДЕТЕКТОР v4.1 (С ONE-HOT ENCODING)
# =============================================================================
